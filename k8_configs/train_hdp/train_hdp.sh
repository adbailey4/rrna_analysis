...
OUTPUT_BUCKET_TMP="bailey-k8s/rrna_experiments/alt_canonical/hdp/"
...
if [[ "$unsupervised" == "true" ]]
  then
    NATIVE_TRAIN_POS="\"/data/reference/alt_canonical_distribution/yeast_18S_25S_min_prob_90_unsupervised.positions\""
  else
    NATIVE_TRAIN_POS="\"/data/reference/alt_canonical_distribution/yeast_18S_25S_modified.positions\""
fi
IVT_TRAIN_POS="\"/data/reference/alt_canonical_distribution/yeast_18S_25S_canonical.positions\""
...
run_training_routine() {
  ...
  do
    ...
    then
      ...
      aws s3 cp --no-progress train_hdp.sh s3://"$OUTPUT_BUCKET"
...
{
  "save_fig_dir": null,
  "positions": "/data/reference/alt_canonical_distribution/yeast_18S_25S_variants.positions",
...
cat << EOF >> train_test_config.json
{
  ...
  "plot_accuracies": {
    "train": {
      "positions_files":
      ["/data/reference/alt_canonical_distribution/yeast_18S_25S_modified.positions",
        "/data/reference/alt_canonical_distribution/yeast_18S_25S_canonical.positions"],
