#!/bin/bash
# A:n C:o G:p T:q
MODELS_BUCKET="bailey-k8s/rrna_experiments/models/small_5mer/"
OUTPUT_BUCKET_TMP="bailey-k8s/rrna_experiments/small_5mer/median/"
...
MIN_SD="$5"
use_gaussian="true"
AMBIG_MODEL="\"/data/reference/small_models/small_variants.model\""
...
if [[ "$unsupervised" == "true" ]]
  then
    NATIVE_TRAIN_POS="\"/data/reference/small_models/small_5mer/yeast_18S_25S_min_prob_90_unsupervised.positions\""
  else
    NATIVE_TRAIN_POS="\"/data/reference/small_models/small_5mer/yeast_18S_25S_modified.positions\""
fi
IVT_TRAIN_POS="\"/data/reference/small_models/small_5mer/yeast_18S_25S_canonical.positions\""
...
EXPERIMENT_NAME="train_${N_TRAIN_READS}_test_${N_TEST_READS}_prob_${P_THRESHOLD}_em_iterations_${EM_ITERATIONS}_gaussian_${use_gaussian}_FREQ_THRESHOLD_${FREQ_THRESHOLD}_USE_IVT_TRAINING_${USE_IVT_TRAINING}_unsupervised_${unsupervised}_all_kmers_${all_kmers}_small_model_5mer_use_median_${USE_MEDIAN}_min_sd_${MIN_SD}"
...
download_files() {
  ...
  cd rrna_scripts && python3.7 -m pip install . && cd ..
...
run_training_routine() {
  ...
  do
    ...
    then
      ...
      aws s3 cp --no-progress small_model.sh s3://"$OUTPUT_BUCKET"
...
{
  "save_fig_dir": null,
  "positions": "/data/reference/small_models/small_5mer/yeast_18S_25S_variants.positions",
...
cat << EOF >> run_config.json
{
  ...
  "samples": [
    {
      "positions_file": "/data/reference/small_models/small_5mer/yeast_18S_25S_variants.positions",
      "fast5_dirs": ["/data/"],
      "bwa_reference": "/data/reference/yeast_25S_18S.fa",
      "fofns": [],
      "readdb": "/data/NOP58_GAL/run_ngal.readdb",
...
cat << EOF >> train_test_config.json
{
  ...
  "plot_accuracies": {
    "train": {
      "positions_files":
      ["/data/reference/small_models/small_5mer/yeast_18S_25S_modified.positions",
        "/data/reference/small_models/small_5mer/yeast_18S_25S_canonical.positions"],
